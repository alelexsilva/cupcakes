...
class ProfileEmailChangeWidget extends StatefulWidget {
  const ProfileEmailChangeWidget({super.key});

  @override
  State<ProfileEmailChangeWidget> createState() =>
      _ProfileEmailChangeWidgetState();
}

class _ProfileEmailChangeWidgetState extends State<ProfileEmailChangeWidget> {
  late ProfileEmailChangeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileEmailChangeModel());

...
/// Functions to query FirebaseCupcakesRecords (as a Stream and as a Future).
Future<int> queryFirebaseCupcakesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FirebaseCupcakesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FirebaseCupcakesRecord>> queryFirebaseCupcakesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FirebaseCupcakesRecord.collection,
      FirebaseCupcakesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FirebaseCupcakesRecord>> queryFirebaseCupcakesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
